          ...
          <div class="feedback__slider-wrapper swiper-wrapper">
            ...
            <li class="feedback-section__item swiper-slide">
              <blockquote class="feedback">
                <h3 class="feedback__title" data-swiper-parallax-opacity="0" data-swiper-parallax-scale="0.2">{{title}}</h3>

                <p class="feedback__text" data-swiper-parallax-opacity="0" data-swiper-parallax="-300" data-swiper-parallax-duration="500"> 
                  {{text}}
                </p>

                <cite class="feedback__author">
                  <img class="feedback__author-avatar" data-swiper-parallax-opacity="0" data-swiper-parallax="-600" data-swiper-parallax-duration="400" width="72" height="72" data-src="/thumbc/72x72/src%7B%7Bavatar.0.img%7D%7D" data-srcset="/thumbc/144x144/src{{avatar.0.img}} 2x" alt="{{name}}" wb-if="'{{avatar}}'&gt;''">
                  <img class="feedback__author-avatar" data-swiper-parallax-opacity="0" data-swiper-parallax="-600" data-swiper-parallax-duration="400" width="72" height="72" data-src="/module/myicons/72/323232/users-06.svg" data-srcset="/assets/img/feedback1@2x.jpg 2x" alt="{{name}}" wb-if="'{{avatar}}'==''">
                  <span class="feedback__name" data-swiper-parallax-opacity="0" data-swiper-parallax="-400" data-swiper-parallax-duration="700">{{name}}</span>
                  <span class="feedback__role"data-swiper-parallax-opacity="0" data-swiper-parallax="-700" data-swiper-parallax-duration="900">{{position}}</span>
                </cite>

                <div class="feedback__actions" data-swiper-parallax-opacity="0" data-swiper-parallax="-700" data-swiper-parallax-duration="300">
