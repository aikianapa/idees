<view>
    <section class="feedback-section section-outer" style="background: url('{{bkg.0.img}}') no-repeat center;">
        <div class="container feedback-section__title-container">
                                ...
                                <li class="feedback-section__item swiper-slide">
                                    <blockquote class="feedback">
                                        <cite class="feedback__author">
                                            <img class="feedback__author-avatar" width="72" height="72" src="/thumbc/72x72/src%7B%7Bavatar.0.img%7D%7D" data-srcset="/thumbc/144x144/src{{avatar.0.img}} 2x" alt="{{name}}" wb-if="'{{avatar}}'&gt;''">
                                        ...
                                        <div class="feedback__bottom">
                                            ...
                                            <button class="button feedback__next-button js-feedback-slider-button--next" type="button" aria-label="Следующий отзыв">
                                                <svg class="feedback__next-button-icon" width="80" height="24" aria-hidden="true">
                                                    <use xlink:href="/assets/img/sprite.svg#big-arrow-2"></use>
                                                </svg>
                                            </button>
                                        </div>
                                        <div class="feedback__actions">
                                            <a class="feedback__watch-link popup-video" href="%7B%7Byoutube%7D%7D" target="_blank" rel="noreferrer noopener nofollow" wb-if="'{{youtube}}'&gt;''">
