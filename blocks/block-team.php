    ...
    <li class="agency__team-item" wb-if="'{{active}}'=='on'">
      <figure class="agency__member">
        <div class="agency__member-photo-wrapper">
          <img class="agency__member-photo" width="513" height="470" src="/thumbc/513x470/src/{{data.image.0.img}}" srcset="/thumbc/1026x940/src/{{data.image.0.img}} 2x" alt="Владимир Ильичёв">
        </div>
