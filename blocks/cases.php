      ...
      <li class="cases-section__item">
        <article class="case">
          ...
          <a class="case__image-wrapper" href="/projects/%7B%7BwbFurlGenerate(%7B%7Bname%7D%7D)%7D%7D">
            <img class="case__image" width="790" height="500" data-src="/thumbc/790x500/src/{{blocks.project_descr.cover.0.img}}" data-srcset="/thumbc/1580x1000/src/{{blocks.project_descr.cover.0.img}} 2x" alt="{{name}}">
          </a>
