<view>
    <div class="project__content-block project__content-item container">
        ...
        <div class="project__content-image-box">
            <wb-foreach wb="from=images&tpl=false">
                <img class="project__content-image popup-image" width="928" height="600"
                     data-src="/thumbc/928x600/src{{img}}" data-srcset="/thumbc/1856x1200/src{{img}} 2x"
                     alt="{{alt}}" wb-if="'{{img}}'>''">
            </wb-foreach>
        </div>
    </div>
...
<edit header="Блок контента">
    ...
    <div class="form-group row">
        <div class="col-6 mb-2">
            <input name="before" wb="module=filepicker&mode=single&width=240&height=150" wb-path="/uploads/projects/"
                   class="pt-0">
        </div>
        <div class="col-6 mb-2">
            <input name="after" wb="module=filepicker&mode=single&width=240&height=150" wb-path="/uploads/projects/"
                   class="pt-0">
        </div>
    </div>
    ...
    <div class="form-group row">
        <div class="col mb-2">
            <input name="images" wb="module=filepicker&mode=multiple&width=160&height=120" wb-path="/uploads/projects/"
                   class="pt-0">
        </div>
    </div>
</edit>