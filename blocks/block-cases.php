        ...
        <div class="container">
            ...
            <div class="cases-new">
                <wb-foreach wb="from=projects&tpl=false">
                    <wb-var cover="" />
                    <wb-data wb="table=projects&item={{_val}}" wb-filter="active=on">
                        <div class="cases-new__case" wb-if="'{{active}}'=='on'">
                            ...
                            <a href="/projects/{{wbFurlGenerate({{name}})}}" class="cases-new__img-link lazy-wrapper">
                                <div class="cases-new__img-wrapper">
                                    <img class="cases-new__img loading lazy-wrapper__img" data-src="/thumbc/1580x1000/src{{_var.cover}}" data-srcset="/thumbc/1580x1000/src{{_var.cover}} 2x" alt="{{descr}}">
                                </div>
                            </a>
