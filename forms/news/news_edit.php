            ...
            <div class="modal-body">
                ...
                <form autocomplete="off" id="{{_form}}EditForm" data-wb-form="{{_form}}" data-wb-item="{{_item}}" class="form-horizontal" role="form">
                    ...
                    <div class="tab-content  p-a m-b-md">
                        ...
                        <label class="col-sm-2 form-control-label">{{_LANG[home]}}</label>
                        <div class="col-sm-2"><label class="switch switch-success"><input type="checkbox" name="home"><span></span></label></div>

                            <div class="form-group row">
                                <label class="col-xs-12 col-sm-3 form-control-label">Тэг</label>
                                <div class="col-xs-12 col-sm-9">
                                    <select name="tag" placeholder="Тэг" style="" class="form-control" data-wb-role="tree" data-wb-item="blogtags">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9" data-wb-role="tree" name="content" data-wb-dict="blogcontent"></div>
                            </div>
